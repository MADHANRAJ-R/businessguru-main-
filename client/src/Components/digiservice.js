    ...
    <div className="digiservice-process-div">
      <div className="digiservice-toWhom-text">
        ...
        <h2>
          ...
          attracting the right kind of traffic. We shall:
        </h2>
        <div className="digitoWhom-points">
          <p>Offer free SEO Audit</p>
          <p>Analyze your competition to stay ahead in the digital race </p>
          <p>
            Advise ranging from content and keyword optimization to user
      ...
      <div className="digiservice-toWhom-text">
        ...
        <br />
        <h2>
          Research indicates that 88% of buyers look for internet reviews before
          deciding to choose a local service. Therefore, local SEO is of
          paramount importance to success of a local business.
        </h2>
        <div className="digitoWhom-points">
          <p>Critically assess your Google My Business (GMB) listing</p>
          <p>
            Ascertain your Name, Address & Phone Number (NAP) visibility and
            build local citations
          </p>
          <p>
            Manage your online reviews through an efficient online review
            acquisition approach
          </p>
          <p>Benchmark you against your competitors</p>
          <p>Analyze organic links and penalties, if any</p>
          <p>
            Research on keywords to find industry-specific and
            geography-specific keywords
          </p>
          <p>
            Create a local SEO guide to assist you in curating
            attention-grabbing content
          </p>
          <p>Track your ranking on GMB through periodic reports</p>
          <p>
            Optimizing your homepage and metadata with geographic-specific
            keywords
          </p>
          <p>
            Set up social media signals and add local business schema to your
            website pages
          </p>
          <p>Produce landing pages for local SEO</p>
          <p>
            Include information about your company in general-purpose as well as
            specialist local directories
          </p>
        </div>
      </div>
      <div className="digiservice-toWhom-text">
        ...
        <h2>
          ...
          measurable results. From compelling content creation to data-driven
